...
function ButtonCta({ label = "Get Access", className, ...props }: ButtonCtaProps) {
    return (
        <Link href="#pricing-section" scroll={false}>
            <Button
                variant="ghost"
                className={cn(
            ...
            <div className="absolute inset-[2px] shadow-[inset_0_0_15px_rgba(199,135,246,0.5)] rounded-lg" />
            ...
            <div className="absolute inset-[2px] rounded-lg bg-gradient-to-r from-[#2A1736]/20 via-[#C787F6]/10 to-[#2A1736]/20 opacity-0 transition-opacity duration-300 group-hover:opacity-100 group-hover:scale-105" />
        </Button>
        </Link>
    );
}
